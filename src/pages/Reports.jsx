                    ...
                    <div className="report-download-section">
                        ...
                        {downloadSuccess && (
                            <div className="report-success-toast">
                                ...
                                <span>PDF Report saved successfully! Check your Downloads folder.</span>
                            </div>
                        )}

                        <p className="report-download-hint">
                            Generate a comprehensive PDF report for {getMonthName(selectedMonth.month)} {selectedMonth.year}
                        </p>
                    </div>
                </>
            )}
